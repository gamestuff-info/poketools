...
import PokemonTable, {PokemonTableRecord, sortFieldMap} from './PokemonTable';
import {pktQuery} from '../common/client';

export default function PokemonEvolvesWithItemTable(props: { itemSlug: string }) {
